...
export function FaqSection() {
  return (
    <section
      id="faq"
      className="scroll-mt-24 border-t border-border/50 bg-white py-20 md:py-28 lg:py-32"
    >
            ...
            >
              {faqs.map((item) => (
                <AccordionItem
                  ...
                  className="border-0"
                >
                  <AccordionTrigger className="py-5 text-left text-[0.9375rem] font-semibold text-foreground hover:no-underline md:text-base">
                    {item.q}
                  </AccordionTrigger>
                  <AccordionContent className="pb-5 pt-0 text-[0.9375rem] leading-relaxed text-muted-foreground">
                    {item.a}
                  </AccordionContent>
                </AccordionItem>
              ))}
