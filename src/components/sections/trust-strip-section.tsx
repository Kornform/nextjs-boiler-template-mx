  ...
  return (
    <section className="border-b border-border bg-card py-6">
      <div className="container-site">
        <RevealOnScroll>
          <div className="flex flex-wrap items-center justify-center gap-x-0 gap-y-0 divide-y divide-border md:flex-nowrap md:divide-x md:divide-y-0">
            {signals.map((signal) => (
              <div
                key={signal.label}
              ...
              >
                <span
                  ...
                  aria-hidden
                />
                <span className="text-[0.8125rem] font-medium whitespace-nowrap text-muted-foreground">
                  {signal.label}
                </span>
              </div>
            ))}
