...
export function TestimonialSection() {
  return (
    <section className="relative overflow-hidden bg-primary py-20 md:py-28">
      <div
        className="pointer-events-none absolute inset-0 bg-grain-strong opacity-40 mix-blend-overlay"
        aria-hidden
      />
      <div className="container-site relative">
        <RevealOnScroll className="mx-auto max-w-3xl">
          <div className="relative rounded-2xl border border-border bg-card p-8 shadow-xl shadow-black/35 md:p-12">
            <Quote
            ...
            <div className="mt-8 flex items-center gap-4 border-t border-border pt-8">
              <div
                className="size-12 shrink-0 rounded-full bg-gradient-to-br from-muted-foreground/40 to-muted-foreground/70 grayscale"
                aria-hidden
              />
              <div>
